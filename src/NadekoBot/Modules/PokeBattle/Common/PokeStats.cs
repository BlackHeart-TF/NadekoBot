...
namespace NadekoBot.Modules.PokeBattle.Common
{
    public class TrainerStats
    {
        ...
        public async Task<TrainerStats> AttackAsync(IUser user, int damage)
        {
            var pkmID = (await Trainer.GetUserPokemonAsync()).Id;
